...
sudo timeout 1000s $Tool -e "$AirDumper" -c 1 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 2 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 3 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 4 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 5 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 6 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 7 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 8 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 9 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 10 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 11 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 12 $wifiInterfaceMon &
...
sudo timeout 1000s $Tool -e "$AirDumper" -c 13 $wifiInterfaceMon &
